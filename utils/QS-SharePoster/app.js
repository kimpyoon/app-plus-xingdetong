	...
	getPosterUrl(objs) { // 后端获取背景图的url路径方法
		...
		return new Promise((rs, rj) => {
			...
			if (backgroundImage)
				...
				// 	//领取证书
				// 	case 'certificate':
				// 		image = 'https://s6.pipacode.cn/86f1920190720192429353.jpg';
				// 		break;
				// 	case 'exclusive':
				// 		image = bgUrl
				// 		break
				// 	// default:
				// 	// 	image =
				// 	// 		'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1559647397216&di=bc7147bcf55dc1223a77f9dcb55baed4&imgtype=0&src=http%3A%2F%2Fb-ssl.duitang.com%2Fuploads%2Fitem%2F201810%2F02%2F20181002104914_crbsb.jpeg';
				// 	// 	break;
				// }
			if(image)
